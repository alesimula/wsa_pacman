...
class ExpanderWin11State extends State<ExpanderWin11>
  ...
  static Color borderColor(ThemeData style, Set<ButtonStates> states) {
    if (style.brightness == Brightness.light) {
      if (states.isHovering && !states.isPressing) return const Color(0xFF212121).withOpacity(0.22);
    ...
    final children = [
        ...
        builder: (context, states) {
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: backgroundColor(theme, states),
              border: Border.all(
                width: borderSize,
      ...
      SizeTransition(
        ...
        child: Transform.translate(offset: const Offset(0, -borderSize), child: Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(width: borderSize, color: borderColor(theme, {ButtonStates.none})),
